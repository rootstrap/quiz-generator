...
function_descriptions = [
    {
        "name": "get_questions",
        "description": "Separate the text into a list of questions",
        "parameters": {
            "type": "list",
            "properties": {
                "text": {
                ...
                "amount": {
                    "type": "number",
                    "description": "The amount of questions",
                },
            },
...
def get_questions(text, amount):
    """Separate the text divided by \n into a list of questions in the format."""
